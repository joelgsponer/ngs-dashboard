...
shinyUI(fluidPage(
  tags$head(
    tags$link(rel = "stylesheet", type = "text/css", href = "styles/patholab.css")
  ),
  ...
  mainPanel(
    tabsetPanel( 
      ...
      ,tabPanel("Database management"
        ,h3("Samples")
        ,checkboxInput("show_tbl_samples", "show table", F)
        ,downloadButton("downloadTableTblSamples")
        ,dataTableOutput("dataTableTblSamples")
        ,h3("Run")
        ,checkboxInput("show_tbl_run", "show table", F)
        ,downloadButton("downloadTableTblRun")
        ,dataTableOutput("dataTableTblRun")
        ,h3("Files")
        ,checkboxInput("show_tbl_files", "show table", F)
        ,downloadButton("downloadTableTblVCF")
        ,dataTableOutput("dataTableTblVCF")
        ,h3("Researcher")
        ,checkboxInput("show_tbl_researchers", "show researchers", F)
        ...
        ,h3("Operator")
        ,checkboxInput("show_tbl_operators", "show operators", F)
